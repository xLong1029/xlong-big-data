...
const components = [BorderFrameOne, BorderFrameTwo, BorderFrameThree, BorderFrameFour, DataLoading, BorderFrameTitleOne, BorderFrameTitleTwo, BorderFrameTitleThree, BorderFrameTitleFour];
